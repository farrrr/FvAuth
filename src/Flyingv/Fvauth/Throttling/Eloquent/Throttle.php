...
use Flyingv\Fvauth\Throttling\UserSuspendedException;
use Flyingv\Fvauth\Throttling\UserBannedException;
...
class Throttle extends Model implements ThrottleInterface {
	...
	{
		return $this->belongsTo('Flyingv\Fvauth\Users\Eloquent\User', 'user_id');
	}
