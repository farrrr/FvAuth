<?php namespace Flyingv\Fvauth\Groups\Eloquent;
/**
...
use Flyingv\Fvauth\Groups\NameRequiredException;
use Flyingv\Fvauth\Groups\GroupExistsException;
...
class Group extends Model implements GroupInterface {
	...
	{
        return $this->belongsToMany('Flyingv\Fvauth\Users\Eloquent\User', 'UserGroup', 'user_id', 'group_id')
	}
